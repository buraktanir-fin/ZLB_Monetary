...
# ============================================================
# ANALYSIS 1 (REVISED): 1990–2008 SUBSAMPLE COMPARISON
#
# Generates ONE figure with three series all estimated over
# the same 1990–2008 window:
#   1. AD shocks       (1990–2008)
#   2. FFR shocks      (1990–2008)
#   3. Wu-Xia shocks   (1990–2008)
#
# Purpose: by holding the sample constant across all three
# instruments, any remaining differences between WX and the
# FFR-based series (AD, FFR) reflect instrument characteristics
...
SAMPLE_END   = "2008-11-01"   # end:   pre-2008 split
...
def plot_three_lines_1990(h, irf_dict, macro_vars, out_fig):
    """
    Three series all estimated over the same 1990-2008 window.
